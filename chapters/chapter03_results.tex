...
For that puropose, Kolmogorov-Smirnov (KS) test has been performed for every centrality measure. As shown in the fourth column table \ref{tab: validation of sy networks}, the associated p-value is $>0.05$ for all the metrics except for the \textit{Degree Count}, which means that there is no significant difference between real and synthetic data. 
