...
From a biological point of view, HI-C matrices are used to identify Topologically Associating Domains (TADs), which are regions with enriched internal interactions and chromatin loops, point interactions between enhancers and promoters and A/B compartments, that means large-scale separation of active (A) and inactive (B) chromatin. 
